# Important imports
from app import app
from flask import request, render_template #front end
import os
...
def index():
	...
	if request.method == "POST":
                ...
                cnts = cv2.findContours(thresh.copy(), cv2.RETR_EXTERNAL, cv2.CHAIN_APPROX_SIMPLE) #contours saved as cnts
...
# Main function to allow our app to run 
